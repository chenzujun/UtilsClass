...
public class Md5 {
    ...
    private static String mymd5(String string, String secret_string,
        ...
        code = (action.equals("DE") ? (Md5.getMD5ofStr(code)
                .substring(6, 6 + 24).equals(md5code) ? code : null) : Base64
                .encode(code) + md5code);
        return code;
    }
    ...
    public static void main(String[] args) {
        System.out.println(Encrypt.decrypt("AF2D1420C49371B1362ED44706657928"));
        
        System.out.println(Encrypt.encrypt("13045922892"));
        
        String workerId = "110";
        String psw = "UUFZUwUFV1JV07ba9723ef0cb3fffebdd578";
        String[] ws = workerId.split("\\,");
        String[] ps = psw.split("\\,");
        for (int i = 0; i < ws.length; i++) {
            System.out.println(String.format("%s\t%s", ws[i],
                    decrpyt(ps[i], null)));
        }
