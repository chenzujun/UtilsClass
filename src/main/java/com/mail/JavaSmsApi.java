...
public class JavaSmsApi {
    ...
    public static void main(String[] args) throws IOException,
        ...
        String apikey = "7a1e4e57d3473cc118ff11a7234de629";

        // 修改为您要发送的手机号
        String mobile = URLEncoder.encode("18101610431", ENCODING);
        ...
        // System.out.println(JavaSmsApi.recevieSms(apikey, 20));
        // 模板发送的调用示例
        /*
         * System.out.println(tpl_value); String tplSendSms =
         * JavaSmsApi.tplSendSms(apikey, tpl_id, tpl_value, mobile); JSONObject
         * jsStr = JSONObject.parseObject(tplSendSms); String
         * code=jsStr.getString("code"); System.out.println("code==="+code);
         */
        // System.out.println(JavaSmsApi.sendSms(apikey, text, mobile));
        /**************** 使用接口发语音验证码 *****************/
        // String code = "1234";
    ...
    public static String recevieSms(String apikey, Integer page_size)
